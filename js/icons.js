...
const UI_ICONS = {
  ...
  logoPlaceholder: `<svg viewBox="0 0 40 26" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="13" cy="13" r="12" stroke="currentColor" stroke-width="2"/><circle cx="27" cy="13" r="12" stroke="currentColor" stroke-width="2"/></svg>`,
